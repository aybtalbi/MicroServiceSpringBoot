...
public class CompteServiceApplication {
    ...
    CommandLineRunner start(CompteRepository compteRepository, RepositoryRestConfiguration restConfiguration) {
        return args -> {
            ...
            compteRepository.save(new Compte(null, 4533 , new Date() , TypeCompte.COURANT));
            compteRepository.save(new Compte(null, 223 , new Date() , TypeCompte.EPARGNE));
            compteRepository.save(new Compte(null, 234 , new Date() , TypeCompte.COURANT));
